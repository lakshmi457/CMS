...
<body>
    <form id="form1" runat="server"> <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="Data Source=LAPTOP-K6EB0TDR;Initial Catalog=NewUSER;Integrated Security=True" DeleteCommand="DELETE FROM [Complaint] WHERE [UserId] = @UserId" InsertCommand="INSERT INTO [Complaint] ([UserId], [Type], [Category], [SubCategory], [Nature], [Details]) VALUES (@UserId, @Type, @Category, @SubCategory, @Nature, @Details)" SelectCommand="SELECT * FROM [Complaint]" UpdateCommand="UPDATE [Complaint] SET [Type] = @Type, [Category] = @Category, [SubCategory] = @SubCategory, [Nature] = @Nature, [Details] = @Details WHERE [UserId] = @UserId" ProviderName="System.Data.SqlClient">
            <DeleteParameters>
