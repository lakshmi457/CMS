...
<body>
    <form id="form1" runat="server">
                    ...
                    <asp:ImageButton ID="ImageButton1" runat="server" Height="234px" ImageUrl="~/Images/Logo.png" Width="746px" OnClick="ImageButton1_Click" style="text-align: center; margin-left: 202px" />
                </asp:Panel>
        <br />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;
        ...
        &nbsp;<hr /><asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Sign in" Width="177px" BackColor="#3399FF" />
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="Data Source=LAPTOP-K6EB0TDR;Initial Catalog=NewUSER;Integrated Security=True" SelectCommand="SELECT * FROM [NewUser]" ProviderName="System.Data.SqlClient"></asp:SqlDataSource>
