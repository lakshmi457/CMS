...
&nbsp;&nbsp;&nbsp;
        <hr /><asp:Panel ID="Panel1" runat="server" BackColor="Black">
            ...
            <asp:Label ID="Label3" runat="server" Font-Size="Large" Text=""></asp:Label><asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="Data Source=LAPTOP-K6EB0TDR;Initial Catalog=NewUSER;Integrated Security=True" SelectCommand="SELECT * FROM [NewUser]" OnSelecting="SqlDataSource1_Selecting" ProviderName="System.Data.SqlClient"></asp:SqlDataSource>
        </div>
    </form>
</body>
</html>
