<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ForgetPassword.aspx.cs" Inherits="WebApplication1._1" %>
...
&nbsp;&nbsp;&nbsp;
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="Data Source=LAPTOP-K6EB0TDR;Initial Catalog=NewUSER;Integrated Security=True" SelectCommand="SELECT [Id], [Password] FROM [NewUser]" ProviderName="System.Data.SqlClient"></asp:SqlDataSource>
    </form>
</body>
</html>
