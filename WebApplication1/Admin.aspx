...
<body>
    <form id="form1" runat="server">
        <div>  <asp:Panel ID="Panel1" runat="server" BackColor="Black" BorderColor="Black">
                    <asp:ImageButton ID="ImageButton1" runat="server" Height="58px" ImageUrl="~/Images/Logo.png" Width="154px" OnClick="ImageButton1_Click" style="text-align: center" />
                </asp:Panel>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;
        <asp:TextBox ID="TextBox2" runat="server"  TextMode="Password" ></asp:TextBox>
             ...
             <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="Data Source=LAPTOP-K6EB0TDR;Initial Catalog=NewUSER;Integrated Security=True" SelectCommand="SELECT [AdminId], [Password] FROM [NewAdmin]" ProviderName="System.Data.SqlClient"></asp:SqlDataSource>
        </div>
    </form>
</body>
</html>
